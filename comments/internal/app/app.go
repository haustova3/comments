...
func (app *App) ListenAndServe(ctx context.Context) error {
	...
	createCommentService := create_comment.NewCreateCommentService(app.rep, productsService, usersService)
	getCommentsService := get_comment.NewGetCommentsService(app.rep)
